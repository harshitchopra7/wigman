...
function Logo({ width = "33.2px", height = "33.2px" }) {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <g filter="url(#filter0_i_2233_341)">
        ...
        <rect
          ...
          height="33.2"
          rx="5.2"
          fill="url(#paint0_linear_2233_341)"
        />
        <rect
          x="0.399994"
          width="33.2"
          height="33.2"
          rx="5.2"
          fill="url(#paint1_linear_2233_341)"
        />
        <rect
          x="0.599994"
          y="0.2"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_2233_341"
          />
        </filter>
        <linearGradient
          id="paint0_linear_2233_341"
          x1="32.6"
          y1="0.600002"
          x2="1.6"
          y2="34.2"
